...
*Guardar el archivo
save "C:\Users\Vladimir Pinto\OneDrive - El Colegio de México A.C\Estudio Amazonico propuesta\Base_de_datos\EH2020_Persona.dta"
...
************************************************
clear all
use "C:\Users\Vladimir Pinto\OneDrive - El Colegio de México A.C\Estudio Amazonico propuesta\Base_de_datos\EH2020_Persona.dta", clear
set more off
...
histogram covid, normal by(condic_etnica)

*iii) Varianzas de los grupos sean homogéneas.
sdtest covid, by( condic_etnica )
...
ranksum covid, by(condic_etnica)
